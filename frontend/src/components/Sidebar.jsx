...
const MENU_ITEMS = [
  ...
  { id: 'elec',    label: 'ค่าไฟฟ้า',     icon: Zap,             color: '#ef4444', bg: 'rgba(239,68,68,0.15)' },
    ...
    >
        ...
        <div className="px-2 mt-3">
          {!collapsed && (
            <div className="px-2 pb-2 flex items-center gap-2">
              <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500">ผู้ดูแลระบบ</span>
      ...
      <div className="mt-auto p-2.5 space-y-2"
        ...
        {user && !collapsed && (
          <div className="rounded-xl p-2.5 flex items-center gap-2.5"
            ...
            <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0 text-white text-sm font-black"
              style={{ background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', boxShadow: '0 4px 12px rgba(139,92,246,0.35)' }}>
            ...
            <button
              onClick={onLogout}
              title="ออกจากระบบ"
              className="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-rose-500/20 transition-all shrink-0"
            >
              <LogOut size={15} />
            </button>
          </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-slate-500 hover:text-slate-200 hover:bg-white/5 transition-all"
        >
          <ChevronRight
            size={13}
